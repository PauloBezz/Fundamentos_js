...
const fullname = 'Paulo Henrique da Silva Bezerra'
...
const lastName = stringToArray[4]
...
/* maiuscula */
const oi = 'EKSPKDSOGKHOS KJPJGOSKGDPKGD'
console.log(fullname.toUpperCase())

const fullRandom = 'PauloXHenriqueXSilvaXdaXBezerra'
const nome = fullRandom.split('X')
console.log(nome)

const myName = 'Paulodaf'
console.log(myName.length)

// busca uma palavra através do indice que você selecionou (inicio, fim)
